      ...
      <div class="row">
        <div class="col-md-12">
          <div>
            ...
            <p class="mb_30 text-justify">
              ...
              installed quickly and efficiently. Plus, we offer competitive prices that
              will fit within your budget. Contact us today to learn more about our
        ...
        <div class="col-md-6">
          <div>
            ...
            <p class="mb_30 text-justify">
              Our team comprises highly trained technicians, ensuring swift and efficient
              Aircond installations. They possess the expertise to handle the task
              proficiently, guaranteeing timely completion without compromising quality.
              Trust our skilled professionals for prompt and efficient air conditioning
        ...
        <div class="col-md-6">
          <div class="repair-image">
            <img
              src="assets/images/aircond-installation/ac-installation-3.jpg"
              alt="Services Image"
            />
          </div>
        </div>
